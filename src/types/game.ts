...
export const LEVELS: LevelConfig[] = [
  ...
  { level: 3, name: "Medium", gridCols: 3, gridRows: 3, pairs: 4, timeBonus: 60 },
  { level: 4, name: "Hard", gridCols: 4, gridRows: 3, pairs: 6, timeBonus: 90 },
  ...
  { level: 7, name: "Legend", gridCols: 5, gridRows: 5, pairs: 12, timeBonus: 180 },
];